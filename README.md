...
![Снимок стартового окна](screenshots/dark/StartDialog.png)

### Основное окно

![Снимок основного окна](screenshots/dark/MainWindow.png)
...
![Снимок диалогового окна выбора траектории](screenshots/dark/TrajectoryDialog.png)

### Окно подтверждения повторного контроля зоны

![Снимок диалогового окна повторного контроля текущей зоны](screenshots/dark/RetestDialog.png)

### Окно завершения работы

![Снимок диалогового окна завершения работы](screenshots/dark/FinishDialog.png)
...
Мы приветствуем улучшение кода, документации и тестов. Пожалуйста, ознакомьтесь с [руководством для контрибьюторов](CONTRIBUTING.md) перед созданием Issue или Pull Request.

## 📞 Обратная связь

- 🐛 Нашли баг или есть идея? → [Создайте Issue](https://github.com/RadioPizza/TPU-TNDT-DualCam-App/issues/new)
- 💬 Вопрос по использованию или архитектуре? → Создайте Issue с меткой `question`

...
_Разработка в планах_

### Окно выбора траектории

![Снимок основного окна](screenshots/trajectory.png)

### Окно подтверждения повторного контроля зоны

![Снимок основного окна](screenshots/retest.png)

### Окно завершения работы

![Снимок основного окна](screenshots/finish.png)
